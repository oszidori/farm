...
public class Help extends JFrame{
    ...
    public void Customize(){
        ...
        different.setFont(new Font("Arial", Font.BOLD, 15));
        different.setForeground(Color.red);
        different.setText("<html>Yellow, Orange, Red: the plant is ready to harvest,<br> the colour depends on the type of the seed.</html>");
